...
import Loader_Detail_Lesson from "./Loader_Detail_Lesson";
const Detail_Lesson = (props) => {
  ...
  return (
    <>
      ...
      >
        {listVocabulary && dataDetailLesson ? (
          <>
              ...
              <div className="div-function">
                ...
                <div
                  ...
                  onClick={() => {
                    if (userData.id !== authorData.id)
                      message.info(
                        "Bạn không được cấp quyền để làm việc này !"
                      );
                ...
                Chia sẻ
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (userData.id !== authorData.id) {
                        message.info(
                          "Bạn không có quyền chỉnh sửa bài học này !"
                        );
                      } else {
