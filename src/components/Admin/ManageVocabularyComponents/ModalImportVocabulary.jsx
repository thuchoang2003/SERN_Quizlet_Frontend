...
const ModalImportVocabulary = (props) => {
  const {
  ...
  console.log("check id", valueDefaultSelect);
  ...
  const handleOk = () => {
    ...
    setTimeout(() => {
      setOpenModalImportVocabulary(false);
  ...
  return (
    <>
      <Modal
        ...
        open={openModalImportVocabulary}
        onOk={handleOk}
...
export default ModalImportVocabulary;
